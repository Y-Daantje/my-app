import { type IAction, type IActionCategory } from "../page/demo";
export const CATEGORIES: IActionCategory[] = [
...
export const MOCK_ACTIONS: IAction[] = [
  ...
  },
  {
    ...
    userTemplate: "Herschrijf dit zodat het eenvoudiger te begrijpen is: {input}",
    systemInstruction: "",
    temperature: 0.75,
    maxTokens: 2048,
    actionCategoryId: "1",
